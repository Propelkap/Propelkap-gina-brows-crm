...
export async function POST(req: Request) {
  // 1. Auth con cliente del usuario (respeta cookie/JWT)
  ...
  // 2. Upsert con service client (bypass RLS — ya validamos user manualmente).
  //    Mas simple que mantener policies para una tabla interna.
